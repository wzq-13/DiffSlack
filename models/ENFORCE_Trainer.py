...
class ENFORCE_Trainer:
    ...
    def save_path_data(self, data_loader: DataLoader = None, path_data_dir='/mnt/sim/carla/carla-ue4-0.9.16/PythonAPI/examples/path_data_V2/ENFORCE') -> Dict[str, float]:
        self.model.eval()
